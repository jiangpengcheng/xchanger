...
转发至公共 DNS。当前只将“行车记录仪”和“车友保险”的真实下载路径替换为
`--intercept-apk` 指定的已注册 APK，其他 APK 和静态资源仍转发真实服务器。
服务器当前使用原版“行车记录仪”APK进行 product 绑定验签测试。当前配置会接受
...
--intercept-apk com.hikvision.carmachinegeely-2018121315.apk
```
